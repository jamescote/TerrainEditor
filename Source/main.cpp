...
int main()
{
	...
	GraphicsManager* m_GpxMngr = nullptr;
	ShaderManager* m_ShdrMngr = nullptr;
	Mouse_Handler* m_MseHndlr = nullptr;
	...
	else
	{
		...
		iRunning = initializeWindow( &m_Window, START_HEIGHT, START_WIDTH, "Modelling" );
